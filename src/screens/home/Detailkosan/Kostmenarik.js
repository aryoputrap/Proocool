...
import Cardlist from '../../../components/kostdetail/cardlist';
  ...
  render() {
    ...
    <Content>
      <View style={styles.container} >
        <Icon style={styles.icon} name="face-agent" size={28}/>
        <Text style={styles.title}>Kos Menarik Skuy-Kost :</Text></View>
      <View>
        <Cardlist item={this.state.kotaPopuler} style={{ width: 200, marginBottom:10 }} />
      </View>
    </Content>
    );
  }
